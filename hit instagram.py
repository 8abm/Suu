...
G="\033[1;32m" # اخضر
H = '\033[1;93m' #اصفر
logo = pyfiglet.figlet_format("Check \n Insta", font = "slant"  )
print(logo)
print("\n <1> 𝙂𝙈𝘼𝙄𝙇 \n <2> 𝗚𝗠𝗔𝗜𝗟 𝗦𝗘𝗔𝗥𝗖𝗛\n <3> 𝗚𝗠𝗔𝗜𝗟 𝗙𝗢𝗟𝗟𝗢𝗪𝗜𝗡𝗚\n <4> 𝗚𝗠𝗔𝗜𝗟 𝗙𝗢𝗟𝗟𝗢𝗪𝗘𝗥𝗦\n <5> 𝗗𝗘𝗟𝗘𝗧𝗘 𝗟𝗜𝗦𝗧 𝗚𝗠𝗔𝗜𝗟 \n <6> 𝘼𝙊𝗟 \n <7> 𝘼𝙊𝗟 𝗦𝗘𝗔𝗥𝗖𝗛 \n <8> 𝘼𝙊𝗟 𝗙𝗢𝗟𝗟𝗢𝗪𝗜𝗡𝗚 \n <9> 𝘼𝙊𝗟 𝗙𝗢𝗟𝗟𝗢𝗪𝗘𝗥𝗦 \n <10> 𝗗𝗘𝗟𝗘𝗧𝗘 𝗟𝗜𝗦𝗧 𝘼𝙊𝗟 \n <11> 𝗚𝗘𝗧 𝗦𝗘𝗦𝗦𝗜𝗢𝗡 ")
took = input("\n <\> 𝘾𝙃𝙊𝙊𝙎𝙀  : ")
def gmail():
...
def gmailsc():
    ...
    while True:
        ...
        userr = str(''.join(random.choice(k)for i in range(6)))
...
def gmailfolr():
    ...
    profile = instaloader.Profile.from_username(L.context, USERNMAE)
    for follower in profile.get_followers():
        email = follower.username+"@gmail.com"
        h+=1
        print(f"<{h}>"+email)
...
def gmailfolg():
    ...
    for followee in profile.get_followees():
        email = followee.username+"@gmail.com"
        h+=1
        print(f"<{h}>"+email)
        with open("username2.txt","a") as kl:
            kl.write(f'{email}\n')
